...
{    
    ...
    public class SerializerTest
    {
        ...
        public void DeserializeSettingsTestSimple()
        {
            ...
            Assert.AreEqual(2, deserialized.Playback.Security.Ipv4Whitelist.Count);
            ...
            Assert.AreEqual("1.1.1.2", deserialized.Playback.Security.Ipv4Whitelist[1].IP);
            Assert.AreEqual("testName2", deserialized.Playback.Security.Ipv4Whitelist[1].Name);
