    ...
    internal class BlobUploader : BlobTransferBase
    {
            ...
            bool shouldDoFileIO = true)
        {
            ...
            try
            {
                ...
                CloudBlockBlob blob = GetCloudBlockBlob(uri, client, subDirectory, name, contentType,
                    getSharedAccessSignature);
                ...
                else
                {
                    ...
                    // do we need to move position to 0?
            ...
            Func<string> getSharedAccessSignature)
        {
            ...
            // TODO: do we always need to extract a file name from the name passed in? 
