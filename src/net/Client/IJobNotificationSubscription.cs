...
namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    /// </summary>
    public partial interface IJobNotificationSubscription
    {
        /// <summary>
        /// Notifcation of job state that subscriber are interested in.
        /// </summary>
        NotificationJobState TargetJobState { get; }
