...
namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    /// </summary>
    [DataServiceKey("ReservedUnitType")]
    internal class EncodingReservedUnitType : BaseEntity<IEncodingReservedUnit>, IEncodingReservedUnit
    {
        /// <summary>
        ///     Name of encoding reserved unit
        /// </summary>
        ...
        public Task<IEncodingReservedUnit> UpdateAsync()
        {
            ...
            return retryPolicy.ExecuteAsync<IMediaDataServiceResponse>(() => dataContext.SaveChangesAsync(this))
                    ...
                    t =>
                    {
                        var data = (EncodingReservedUnitType)t.Result.AsyncState;
                        return data;
                    });
        }
