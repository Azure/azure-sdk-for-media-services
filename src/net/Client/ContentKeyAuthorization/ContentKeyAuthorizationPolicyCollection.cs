//-----------------------------------------------------------------------
// <copyright file="ContentKeyAuthorizationPolicyCollection.cs" company="Microsoft">Copyright 2014 Microsoft Corporation</copyright>
// <license>
...
namespace Microsoft.WindowsAzure.MediaServices.Client.ContentKeyAuthorization
{
    public class ContentKeyAuthorizationPolicyCollection : CloudBaseCollection<IContentKeyAuthorizationPolicy>
    {
            ...
            : base(context)
        {
			...
			this.Queryable = factory.CreateDataServiceContext().CreateQuery<IContentKeyAuthorizationPolicy, ContentKeyAuthorizationPolicyData>(ContentKeyAuthorizationPolicySet);
        }
