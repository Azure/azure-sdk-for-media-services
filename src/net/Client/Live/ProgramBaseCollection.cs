...
namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    public class ProgramBaseCollection : CloudBaseCollection<IProgram>
    {
        ...
        /// <summary>
        /// Sends create program operation to the service and returns. Use Operations collection to get operation's status.
        /// </summary>
        /// <param name="name">Name of the program.</param>
        /// <param name="enableArchive">True if the program must be archived.</param>
        /// <param name="lookAheadChunks">Number of look ahead chunks.</param>
        ...
        public IOperation<IProgram> SendCreateOperation(
            string name,
            bool enableArchive,
            int lookAheadChunks,
            TimeSpan? dvrWindowLength,
            ...
            string assetId)
        {
            ...
            var result = new Operation<IProgram>()
            {
                ErrorCode = null,
                ErrorMessage = null,
                Id = operationId,
        ...
        /// <summary>
        /// Sends create program operation to the service asynchronously. Use Operations collection to get operation's status.
        /// </summary>
        /// <param name="name">Name of the program.</param>
        /// <param name="enableArchive">True if the program must be archived.</param>
        /// <param name="lookAheadChunks">Number of look ahead chunks.</param>
        ...
        public Task<IOperation<IProgram>> SendCreateOperationAsync(
            string name,
            bool enableArchive,
            int lookAheadChunks,
            TimeSpan? dvrWindowLength,
            ...
            string assetId)
        {
            return SendCreateOperationAsync(
                name,
                null,
                enableArchive,
                lookAheadChunks,
        ...
        public Task<IOperation<IProgram>> SendCreateOperationAsync(
            ...
            string assetId)
        {
            return Task.Factory.StartNew(() => SendCreateOperation(
                name,
                description,
                enableArchive,
                lookAheadChunks,
