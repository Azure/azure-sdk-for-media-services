...
namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    internal partial class AssetFileData : IAssetFile, ICloudMediaContextInit
    {
        ...
        {
            return this.DownloadToFileAsync(destinationPath, blobTransferClient, locator, RetryPolicies.RetryExponential(RetryPolicies.DefaultClientRetryCount, RetryPolicies.DefaultClientBackoff), cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A function delegate that returns the future result to be available through the Task.</returns>
        internal Task DownloadToFileAsync(string destinationPath,BlobTransferClient blobTransferClient, ILocator locator, RetryPolicy retryPolicy, CancellationToken cancellationToken)
        {
