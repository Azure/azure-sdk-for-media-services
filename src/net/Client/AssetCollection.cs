...
namespace Microsoft.WindowsAzure.MediaServices.Client
{
    ...
    public class AssetCollection : AssetBaseCollection
    {
        ...
        {
			this._assetQuery = new Lazy<IQueryable<IAsset>>(() => this.MediaContext.MediaServicesClassFactory.CreateDataServiceContext().CreateQuery<IAsset, AssetData>(AssetSet));
        }
